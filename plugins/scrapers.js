...
if (config.WORKTYPE == 'private') {
   ...
   const PIC = await axios.get(`${config.A_PIC}`, {responseType: 'arraybuffer'})
       ...
       if (config.DEL == 'true') {
        await message.client.deleteMessage(message.jid, {id: dl.key.id, remoteJid: message.jid, fromMe: true})
        await message.client.deleteMessage(message.jid, {id: ul.key.id, remoteJid: message.jid, fromMe: true})        
        }
