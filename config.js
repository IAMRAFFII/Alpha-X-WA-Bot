...
module.exports = {
    ...
    D_SONG: process.env.DOWNLOAD_SONG === undefined ? '*🄳ᴏᴡɴʟᴏᴀᴅɪɴɢ ʏᴏᴜʀ ꜱᴏɴɢ...* 📥' : process.env.DOWNLOAD_SONG,
    U_SONG: process.env.UPLOAD_SONG === undefined ? '*🅄ᴘʟᴏᴀᴅɪɴɢ ʏᴏᴜʀ ᴠɪᴅᴇᴏ...* 📤' : process.env.UPLOAD_SONG,
